...
<div class="cr-bottom">
						<div class="crb-box" id="box-small1">
							<div class="bbox-head">
								<div class="bbxh-left">List Absensi</div>
							...
							<div class="bbox-cont" id="box-cont1">
								...
								<form method="post" action="<?php echo base_url(); ?>absensi/searchabsensi" autocomplete="off">
									<label>Filter : </label>
									<input type="text" name="searchkey" class="input-select" placeholder="Nama Pegawai"/>
