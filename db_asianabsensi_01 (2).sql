...
--
-- Host: 127.0.0.1
-- Generation Time: 23 Jul 2017 pada 10.35
...
CREATE TABLE `absensi_record` (
  ...
  `absensi_setafterrest` time NOT NULL,
  `absensi_notes` text NOT NULL,
  `absensi_createdate` datetime NOT NULL,
  `absensi_tstatus` enum('Telat','Tepat Waktu') NOT NULL DEFAULT 'Tepat Waktu',
  `absensi_status` enum('Masuk','Sakit','Alpha','Izin') NOT NULL DEFAULT 'Alpha'
...
INSERT INTO `absensi_record` (`id_absensi_record`, `worker_id`, `absensi_date`, `absensi_morningtime`, `absensi_restout`, `absensi_restin`, `absensi_gohome`, `absensi_setafterrest`, `absensi_notes`, `absensi_createdate`, `absensi_tstatus`, `absensi_status`) VALUES
(3, 1, '2017-07-15', '08:00:00', '12:00:00', '13:00:00', '17:00:00', '00:00:00', 'Tidak telat', '2017-07-15 08:50:27', '', 'Masuk'),
(4, 2, '2017-07-15', '08:05:00', '12:00:00', '13:00:00', '17:00:00', '00:00:00', 'Telat 5 Menit', '2017-07-15 08:53:04', '', ''),
(5, 2, '2017-07-23', '08:01:00', '12:00:00', '12:59:00', '17:00:00', '12:59:00', 'Tepat Waktu', '2017-07-23 10:13:12', 'Tepat Waktu', 'Masuk'),
(6, 1, '2017-07-23', '08:05:00', '12:00:00', '15:25:15', '17:00:00', '12:56:00', 'Absensi hari ini TERLAMBAT', '2017-07-23 10:14:14', 'Telat', 'Masuk'),
(7, 3, '2017-07-23', '08:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', 'Hari ini tidak masuk', '2017-07-23 15:29:10', 'Tepat Waktu', 'Alpha');
...
('admasian', 'b37fdcbdc8ed55153c9dd1eb52f5a8ce', 1500787309),
...
(3, '56565656', 'Vieta Chinthia', 'Lorem ipsum dolor sit amet', '0812345678', 'vieta@gmail.com', '2016-08-11', 'Now', 'Staff', '3000000', '2017-07-23 08:16:17', 'Publish');
...
--
ALTER TABLE `absensi_record`
  MODIFY `id_absensi_record` int(111) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `worker_record`
--
ALTER TABLE `worker_record`
  MODIFY `id_worker_record` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
